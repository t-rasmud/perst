...
public class AltBtree extends PersistentResource implements Index { 
    ...
    public IPersistent[] getPrefix(String prefix) { 
        return get(new Key(prefix, true), new Key(prefix + Btree.MAX_CHAR, false));
    }
    ...
    public Iterator prefixIterator(String prefix, int order) {
        return iterator(new Key(prefix), new Key(prefix + Btree.MAX_CHAR, false), order);
    }
    ...
    public int indexOf(Key key) { 
        Iterator iterator = iterator(null, key, DESCENT_ORDER);
        int i;
